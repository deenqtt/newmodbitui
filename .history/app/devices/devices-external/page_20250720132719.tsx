                      ...
                      <div className="flex items-center gap-2">
                        {latestPayload ? (
                          <>
                            ...
                            <Button variant="ghost" size="icon" className="h-6 w-6" onClick={() => setViewingPayload({ topic: device.topic, payload: latestPayload })}>
                              <Eye className="h-4 w-4" />
                            </Button>
                          </>
                        ) : (
                          <span className="text-xs text-muted-foreground">Menunggu data...</span>
                        )}
                      </div>
                    </TableCell>
