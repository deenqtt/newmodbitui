...
function DevicesForLoggingContent() {
  ...
  // FUNGSI SAVE DILENGKAPI DENGAN FETCH API
  const handleSave = async (e: FormEvent) => {
    ...
    try {
      ...
      handleCloseModal();
      fetchInitialData(); // Muat ulang data untuk menampilkan perubahan
    } catch (error: any) {
      Swal.fire({ icon: "error", title: "Oops...", text: error.message });
    }
  };

  // FUNGSI DELETE DILENGKAPI DENGAN FETCH API
  const handleDelete = async () => {
    ...
    try {
      ...
      fetchInitialData(); // Muat ulang data
    } catch (error: any) {
      ...
      <AlertDialog open={isDeleteAlertOpen} onOpenChange={setIsDeleteAlertOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action will permanently delete the logging configuration for
              "{configToDelete?.customName}".
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
