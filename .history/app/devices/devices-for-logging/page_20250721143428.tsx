...
function DevicesForLoggingContent() {
  // --- Hooks & State ---
  // Gunakan hook yang benar dari context
  ...
  useEffect(() => {
    ...
    // Cleanup function: akan berjalan saat modal ditutup atau device diubah
    return () => {
      console.log(`[Logging Page] Unsubscribing from topic: ${topic}`);
  ...
  const handleDeviceSelectInModal = (uniqId: string) => {
    ...
    // Reset state terkait saat device berubah
  ...
  const handleOpenModal = (
    ...
    setModalPayload(null); // Selalu reset payload saat modal dibuka
    setIsModalOpen(true);
  };
          ...
          <form onSubmit={handleSave} className="space-y-4 pt-4">
            <div>
              ...
              <Select
                ...
                disabled={isUpdateMode} // Disable changing device on edit mode
              >
                <SelectTrigger>
