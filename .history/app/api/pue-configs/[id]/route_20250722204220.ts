...
/**
 * FUNGSI PUT: Memperbarui konfigurasi PUE.
 */
export async function PUT(
  ...
  try {
    ...
    // UPDATE: Saat ini, nilai 'value' di pduList dan mainPower disetel ulang ke null
    // Anda mungkin ingin mempertahankan nilai yang sudah ada di database jika tujuannya hanya
    // mengupdate konfigurasi, bukan nilai daya real-time.
    // Jika perlu mempertahankan nilai, Anda harus mengambil data yang ada, lalu menggabungkan perubahan.
    // Untuk tujuan konfigurasi, meresetnya ke null saat PUT config mungkin logis,
    // dan nilai real-time akan diisi oleh MQTT listener service.
