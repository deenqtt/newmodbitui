...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Buat perangkat virtual baru untuk tujuan publish
    ...
    const newConfig = await prisma.billConfiguration.create({
      data: {
        ...
        // --- PERUBAHAN DI SINI ---
        sourceDeviceUniqId: body.sourceDeviceUniqId, // Gunakan sourceDeviceUniqId
        sourceDeviceKey: body.sourceDeviceKey,
        rupiahRatePerKwh: body.rupiahRatePerKwh,
        dollarRatePerKwh: body.dollarRatePerKwh,
        publishTargetDeviceUniqId: targetDevice.uniqId, // Gunakan uniqId dari target device
      },
    });
