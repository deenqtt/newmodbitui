...
const AlarmDialog = ({
  ...
  useEffect(() => {
    ...
    const handleMessage = (topic: string, message: Buffer) => {
      if (topic === subscribedTopic) {
        try {
          ...
          console.log(
            `[Debug] 4. Message received on topic '${topic}':`,
            payloadStr
          );
          ...
          if (typeof outerPayload.value === "string") {
            ...
            console.log(
              "[Debug] 6b. Outer payload set as live payload:",
              outerPayload
            );
          }
        } catch (e) {
    ...
    console.log(
      `[Debug] Attaching MQTT message listener for topic: ${subscribedTopic}`
    );
    client.on("message", handleMessage);

    return () => {
      console.log(
        `[Debug] Removing MQTT message listener for topic: ${subscribedTopic}`
      );
