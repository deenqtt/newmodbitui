...
import { Card, CardContent } from "@/components/ui/card"; // Impor Card
  ...
  return (
    <TooltipProvider>
      ...
      <main className="p-4 md:p-6 space-y-6">
        {/* Panel Kontrol Baru untuk Tombol dan Status */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button size="sm" onClick={() => handleOpenForm("add")}>
        ...
        {/* Konten Utama (Tabel) dibungkus dalam Card */}
