...
function UserManagementContent() {
  ...
  >("connecting"); // State baru untuk status DB
  ...
  useEffect(() => {
    ...
    checkDb();
    const interval = setInterval(checkDb, 30000); // Cek setiap 30 detik
    return () => clearInterval(interval);
  }, []);

  // useEffect untuk mengambil data pengguna (diperbaiki)
  useEffect(() => {
  ...
  return (
    // TooltipProvider diperlukan untuk menampilkan tooltip status DB
    <TooltipProvider>
