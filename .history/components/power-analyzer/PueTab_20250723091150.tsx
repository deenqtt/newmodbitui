...
export function PueTab() {
  ...
  const updateMainPowerTopic = (selectedTopicUniqId: string) => {
    ...
    // Log setelah set state, perhatikan bahwa state mungkin belum diperbarui di sini
    // Jika Anda ingin melihat nilai terbaru, gunakan useEffect atau log di dalam setState callback
    // console.log(`[PUE Tab] Main Power filtered keys:`, mainPowerForm.filteredKeys); // Ini mungkin menunjukkan nilai lama
  };
