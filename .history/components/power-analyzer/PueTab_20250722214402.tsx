...
export function PueTab() {
              ...
              pdu.keys.forEach((key) => {
                if (key in parsedPayload) {
                  ...
                  if (!isNaN(value)) {
                    ...
                    console.warn(
                      `Key "${key}" has non-numeric value: ${parsedPayload[key]}`
                    );
                  }
                } else {
          ...
          if (mainPowerTopicName === topicName) {
            ...
            if (mainKey in parsedPayload) {
              ...
              if (!isNaN(value)) {
                ...
                console.warn(
                  `Main Power Key "${mainKey}" has non-numeric value: ${parsedPayload[mainKey]}`
                );
              }
            } else {
  ...
  const updatePduTopic = (index: number, selectedTopicUniqId: string) => {
    setPduListForm((prev) => {
      ...
      ).filter((key) => key.toLowerCase().includes("power"));
              ...
              <div className="grid gap-4 py-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        >
                          ...
                          <SelectContent>
                            {/* Dihapus: <SelectItem value="" disabled>Select a device</SelectItem> */}
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      {/* Dihapus: <SelectItem value="" disabled>Select a key</SelectItem> */}
