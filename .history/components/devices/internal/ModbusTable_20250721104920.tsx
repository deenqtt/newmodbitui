...
export function ModbusTable() {
  ...
  const handleMqttMessage = useCallback((message: Paho.Message) => {
    ...
    // --- PERBAIKAN DI SINI ---
    // Sekarang memeriksa `payload.status` bukan `payload.result`
    if (payload.status === "success" || payload.status === "error") {
      Swal.fire({
        icon: payload.status, // Menggunakan payload.status sebagai ikon
        title: payload.status.charAt(0).toUpperCase() + payload.status.slice(1),
        text: payload.message,
        timer: 2000, // Menambahkan timer agar notifikasi hilang otomatis
  ...
  }, [client, connectionStatus, handleMqttMessage]);
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="max-w-3xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Fill in the details below to configure a new device.
            </DialogDescription>
          </DialogHeader>
          <form
          ...
          >
            ...
            <DialogFooter className="pt-4">
              ...
              <Button type="submit" disabled={isLoadingCatalog}>
      ...
      <Dialog open={isSpecialModalOpen} onOpenChange={setIsSpecialModalOpen}>
        <DialogContent className="max-w-3xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Modify the configuration for this special device.
            </DialogDescription>
          </DialogHeader>
          <form
            onSubmit={handleFormSubmit}
