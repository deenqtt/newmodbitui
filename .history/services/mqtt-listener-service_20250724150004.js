...
// GANTI SELURUH FUNGSI fetchAndSubscribeConfigs DENGAN INI
...
async function fetchAndSubscribeConfigs() {
  ...
  try {
    ...
    // --- LOGIKA DETEKSI PERUBAHAN BARU ---
    // Helper untuk membuat "sidik jari" unik untuk setiap konfigurasi
    ...
    // Bandingkan ukuran dan isi dari sidik jari
    ...
    if (configsChanged) {
      ...
      // Kumpulkan UniqID dari semua konfigurasi (logika ini sudah benar)
      ...
      // ... sisa dari fungsi ini (mengambil device, subscribe, unsubscribe) tidak perlu diubah ...
