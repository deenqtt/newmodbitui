...
// --- PERBAIKAN: Gunakan port dan protokol WebSocket ---
const MQTT_HOST = process.env.NEXT_PUBLIC_MQTT_HOST || "localhost";
// Menggunakan port 9000 untuk koneksi WebSocket
const MQTT_PORT = process.env.NEXT_PUBLIC_MQTT_PORT || "9000";
// Menggunakan protokol 'ws://' untuk WebSocket
...
async function startService() {
  ...
  try {
    ...
    const client = mqtt.connect(MQTT_URL, {
      ...
      reconnectPeriod: 5000, // Coba hubungkan kembali setiap 5 detik
    });
