...
async function startService() {
  ...
  mqttClient.on("message", async (topic, message) => {
    ...
    console.log(`[DEBUG] Topik: ${topic}`);
    console.log(`[DEBUG] Payload Mentah: ${payloadStr}`);
    ...
    if (!device) {
      console.log(
        `[DEBUG] GAGAL: Topik ini tidak ditemukan di tabel DeviceExternal. Proses dihentikan.`
      );
      console.log(
        `=============================================================`
      );
    ...
    console.log(
      `[DEBUG] Ditemukan Device: ${device.name} (UniqID: ${updatedDeviceUniqId})`
    );
    console.log(
    ...
    console.log(
      `[DEBUG] Menemukan ${relevantBillConfigs.length} Bill Configs yang relevan.`
    );
    ...
    console.log(
      `[DEBUG] Menemukan ${relevantPueConfigs.length} PUE Configs yang relevan.`
    );
    ...
    console.log(
      `[DEBUG] Menemukan ${relevantPowerAnalyzerConfigs.length} Power Analyzer Configs yang relevan.`
    );
