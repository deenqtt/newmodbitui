// File: components/widgets/CctvMonitorVideos/CctvMonitorVideosConfigModal.tsx
"use client";
...
export const CctvMonitorVideosConfigModal = ({
    ...
    try {
      ...
      if (validCameras.length === 0) {
        Swal.fire({
          ...
          text: "No cameras found with API Key and Group configured. Please configure at least one camera with Shinobi NVR settings.",
        });
      }
    } catch (error: any) {
  ...
  const handleSave = () => {
    ...
    const config = {
      ...
      maxVideos: maxVidsNum,
      autoRefresh,
      refreshInterval: autoRefresh ? refreshNum : undefined,
    };
        ...
        <div className="grid gap-6 p-6">
          ...
          <div className="grid gap-2">
            ...
            <Input
              ...
              placeholder="e.g., Lobby Camera Videos"
            />
          </div>

          {/* Camera Selection */}
          <div className="grid gap-2">
            <Label htmlFor="camera">Camera (with NVR API)</Label>
            {isLoadingCameras ? (
              ...
              >
                <SelectTrigger id="camera">
                  <SelectValue placeholder="Select a camera with API configuration" />
                </SelectTrigger>
                <SelectContent>
                  {cameras.map((camera) => (
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Limit the number of videos shown (1-100)
              </p>
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="autoRefresh">Auto refresh video list</Label>
            </div>
            ...
            {autoRefresh && (
              <div className="grid gap-2">
                ...
                />
                <p className="text-xs text-muted-foreground">
                  How often to refresh the video list (10-300 seconds)
                </p>
              </div>
            )}
          </div>
