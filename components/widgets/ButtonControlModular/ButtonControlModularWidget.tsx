...
export const ButtonControlModularWidget = ({ config }: Props) => {
  ...
  const handleToggle = () => {
    ...
    console.log(`[MQTT PAYLOAD]:`, JSON.stringify(commandPayload, null, 2));

    publish(commandTopic, JSON.stringify(commandPayload));
  };

  // Status styling - KONSISTEN DENGAN WIDGET LAIN + BETTER DARK MODE
    ...
    switch (currentState) {
      case "ON":
        return {
          ...
          buttonShadow: "shadow-lg shadow-blue-500/50 dark:shadow-blue-600/30",
      ...
      case "OFF":
        return {
          ...
          pulse: false,
          buttonBg: "bg-slate-400 dark:bg-slate-700",
          buttonHover: "hover:bg-slate-500 dark:hover:bg-slate-600",
          buttonShadow: "",
      ...
      <div className="flex flex-col items-center justify-center gap-4 h-full">
        ...
        <div className="flex items-center gap-2">
          ...
          <p
            className={cn(
              "font-semibold",
              currentState === "ON" && "text-blue-600 dark:text-blue-400",
  ...
  return (
    ...
    >
      {/* HEADER - Fixed position dengan pattern konsisten (TANPA z-10) */}
      <div
