    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 p-4 sm:p-6">
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap mb-6">
        <div className="flex items-center space-x-4">
          <button
            onClick={() => router.back()}
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white border border-slate-200 text-slate-700 hover:bg-slate-100 hover:border-slate-300 transition-colors font-medium shadow-sm"
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900">Manage Device</h1>
        ...
        <div className="bg-white p-3 rounded-lg shadow-sm border border-slate-200 flex items-center space-x-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="md:col-span-3">
                <button
                  ...
                  className="w-full md:w-auto bg-sky-600 text-white px-4 py-2 rounded-md shadow-sm hover:bg-sky-700 flex items-center gap-2 justify-center disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
                  <PlusCircle size={18} />
                ...
                <tbody className="bg-white divide-y divide-slate-200">
                  {isLoading ? (
                    ...
                    currentUsers.map((user) => (
                      <tr
                        key={user.jobId}
                        className="even:bg-slate-50/50 hover:bg-sky-50/50 transition-colors"
                      >
                    ...
                    <tr>
                      ...
                      >
                        <div className="flex flex-col items-center gap-2">
                          <Users2 size={32} className="text-slate-400" />
              ...
              <div className="px-6 py-3 border-t border-slate-200 flex justify-between items-center">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-3 py-1 text-sm rounded-md bg-white border border-slate-300 hover:bg-slate-100 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Previous
                  </button>
                  <button
        ...
        <div className="space-y-6">
          {/* --- System Vitals --- */}
          <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
            <h3 className="font-semibold text-slate-900 border-b border-slate-200 pb-3 mb-4">
              System Vitals
            </h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
            ...
            <form onSubmit={handleChangeAddress} className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-slate-600 text-white px-4 py-2 rounded-md shadow-sm hover:bg-slate-700 flex items-center gap-2 justify-center disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                <ServerCog size={18} />
                <span>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
            ...
            <div className="flex items-center justify-between gap-6">
              <button
                ...
                disabled={isActionLoading}
                className="flex flex-col items-center text-slate-600 hover:text-sky-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-center"
              >
                <RefreshCw size={24} />
              ...
              <button
                ...
                disabled={isActionLoading}
                className="flex flex-col items-center text-slate-600 hover:text-red-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-center"
              >
              ...
              <button
                ...
                disabled={isActionLoading}
                className="flex flex-col items-center text-gray-600 hover:text-orange-600 disabled:opacity-50 transition-colors"
              >
                <UserX size={24} />
              ...
              <button
                ...
                disabled={isActionLoading}
                className="flex flex-col items-center text-gray-600 hover:text-purple-600 disabled:opacity-50 transition-colors"
              >
                <Download size={24} />
