...
INSERT INTO "new_NodeTenantLocation" ("createdAt", "description", "id", "isActive", "latitude", "longitude", "name", "status", "topic", "updatedAt", "url") SELECT "createdAt", "description", "id", "isActive", "latitude", "longitude", "name", "status", "topic", "updatedAt", "url" FROM "NodeTenantLocation";
